...
var zones = map[area.ID]ZoneInfo{
	...
	area.PitLevel1:               {Act: 1, ExpTier: TierS, LootTier: TierS, BossPack: "27-35", Immunities: []string{"f", "c", "l", "ph"}, Group: "Cathedral / Catacombs"},
	area.StonyField:              {Act: 1, ExpTier: TierC, LootTier: TierC, BossPack: "7-9", Immunities: []string{"f", "c", "l", "p"}, Group: "Stony Field"},
	area.Tristram:                {Act: 1, ExpTier: TierC, LootTier: TierC, BossPack: "8-11", Immunities: []string{"f", "c", "l"}, Group: "Pit"},
